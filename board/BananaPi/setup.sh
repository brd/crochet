...
BPI_UBOOT="u-boot-bananapi"
BPI_UBOOT_BIN="u-boot.bin"
...
raspberry_pi_populate_boot_partition ( ) {
    ...
    # BananaPi firmware loads
    freebsd_install_fdt bananapi.dts

    # Install ubldr to FAT partition
    freebsd_ubldr_copy_ubldr .
}

strategy_add $PHASE_BOOT_INSTALL banana_pi_populate_boot_partition
